...
TEST_CASE("Matrix3", "[.all][matrix][Matrix3]")
{
	...
	SECTION("Arithmetic")
	{
		PenMath::Mat3 const small{
			PenMath::Vector3{1.f, 2.f, 3.f},
			PenMath::Vector3{2.f, 3.f, 4.f},
			PenMath::Vector3{3.f, 4.f, 1.f}
		};

		PenMath::Mat3 const big{
			PenMath::Vector3{9.f, 8.f, 7.f},
			PenMath::Vector3{8.f, 7.f, 6.f},
			PenMath::Vector3{7.f, 6.f, 9.f}
		};
